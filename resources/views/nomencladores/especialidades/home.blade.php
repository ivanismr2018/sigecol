...
<li class="breadcrumb-item"><a href="{{ route('especialidad_home') }}">Especialidades</a></li>
@endsection
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Listado general de las Especialidades de los colaboradores</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <button class="btn btn-primary" type="button" onclick="showModalNuevo()">
            <i class="fa fa-plus fa-sm"></i> Agregar Especialidad
        </button>
        <hr>
...
<div class="modal fade" id="especialidadesModal" style="padding-right: 15px;" aria-modal="true" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        {!! Form::open(['id'=>"frmNuevo", 'method'=>"POST", 'onsubmit'=>"return nuevo()"]) !!}
            {!! Form::text('id', null, ['id'=>'id','hidden']) !!}
            <div class="modal-header">
            <h4 class="modal-title" id="titulo-especialidades">Agregar Especialidad</h4>
...
@section('js')
<script src="{{ asset('js/paginas/especialidades.js') }}"></script>
@endsection
