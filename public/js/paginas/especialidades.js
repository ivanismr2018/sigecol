...
function showModalNuevo(){
    ...
    document.getElementById("titulo-especialidades").innerHTML = "Agregar Especialidad";
...
function nuevo() {
    ...
    $.ajax({
        method: "POST",
        data: datosact,
        url: baseurl+"nomencladores/especialidad/agregar",
...
function cargarDatos(id){
    ...
    document.getElementById("titulo-especialidades").innerHTML = "Actualizar Especialidad";
    ...
    $.ajax({
        "type":"POST",
        "data":{'id':id},
        "url": baseurl+'nomencladores/especialidad/cargarDatos',
...
function actualizar() {
    ...
    $.ajax({
        method: "POST",
        data: datosact,
        url: baseurl+"nomencladores/especialidad/actualizar",
        success:function(data){
          if (data == 1) {
...
function eliminar(id){
    Swal.fire({
        ...
        $.ajax({
            type:"POST",
            data: {'id': id},
            url:baseurl+"nomencladores/especialidad/eliminar",
            success:function(r){
                if (r==1){
...
function mostrarDatos() {
    ...
    "ajax": {
            "url": baseurl+"nomencladores/especialidad/listar",
            "type": "POST",
            dataSrc: ''
            },
    "columns": [
